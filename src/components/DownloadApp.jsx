    ...
    <div className="bg-lightest-green grid grid-cols-1 md:grid-cols-2 border-x border-black">
      <div className="h-auto w-auto m-4 md:m-8">
        ...
        <div className="flex flex-wrap justify-center md:justify-start">
          <button
            type="button"
            className="flex items-center justify-center w-40 md:w-48 text-white bg-black h-12 md:h-14 rounded-xl mr-4 md:mr-8 my-2"
          >
            <div className="mr-3">
              <svg viewBox="0 0 384 512" width="30" className="md:w-8">
          ...
          <button
            type="button"
            className="flex items-center justify-center w-40 md:w-48 text-white bg-black rounded-lg h-12 md:h-14 my-2"
          >
            <div className="mr-3">
              <svg viewBox="30 336.7 120.9 129.2" width="30" className="md:w-8">
      ...
      <div className="h-auto w-auto pt-8 hidden md:block md:pt-24 flex justify-center">
        <img
          src={StatsImage}
          alt="Stats"
          className="h-40 md:h-auto md:w-auto"
        />
      </div>
    </div>
  );
