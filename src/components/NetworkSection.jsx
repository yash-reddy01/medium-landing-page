...
export const NetworkSection = () => {
    return <div className="bg-skin">
       <div className="flex flex-col justify-center items-center px-48 mx-48 py-8 ">
            <div className="text-7xl text-center font-medium">
                A living network of curious minds.
            </div>
            <div className="py-4 px-16 font-light tracking-normal">
                <p>
